...
const CareersSection = ()=>{
    ...
    const onSubmit = async (data)=>{
        ...
        try {
            await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$emailjs$2d$com$2f$es$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["default"].send(serviceId, templateId, {
                name: data.name,
                email: data.email,
